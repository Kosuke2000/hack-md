...
[JSX の中に Javascript 書く](https://beta.reactjs.org/learn/javascript-in-jsx-with-curly-braces)とは、以下のような場合です。ここでは、JSXの中に、`nabeatsu` `count` `countUp` という 3つの JavaScript が書かれています。
